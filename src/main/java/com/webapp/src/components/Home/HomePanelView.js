...
const HomePanelView = ({articles, mediaType, fetchInProgress, fetchInProgressCalled, handleReloadNeeded, handleArticleClick}) => {
    ...
    if (articles.length === 0) {
        return (
            <div className="nothing">There is no recent news available</div>
        )
    }
